      ...
      {socialLinks.map(({ href, icon: Icon, hover }) => (
        <Link key={href} href={href} legacyBehavior>
          <a
            ...
            className={`group bg-white dark:bg-zinc-950 hover:bg-gray-100 dark:hover:bg-zinc-900 rounded-md px-4 py-2 border border-gray-200 dark:border-gray-700 flex items-center justify-start focus:outline-none focus:ring-2 focus:ring-yellow-400 ${hover} dark:focus:ring-yellow-400`}
          >
